...
{	
	...
	private HashSet<String> codigosUtilizados;
	private static final int RADIO_TERRESTRE = 6371;
	
    // TODO completar
    
	public Aeropuerto(String nombre, String codigo, String nombreCiudad,double latitud,double longitud,  HashSet<String> codigosUtilizados ) {
		this.nombre = nombre;
		this.codigo = codigo;
